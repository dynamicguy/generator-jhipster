...
import java.util.*;<% if (searchEngine === 'elasticsearch' || searchEngine === 'solr') { %>
...
public class UserResource {
    ...
    private final UserService userService;<% if (searchEngine === 'elasticsearch' || searchEngine === 'solr') { %>

    private final UserSearchRepository userSearchRepository;<% } %>

    public UserResource(UserRepository userRepository, MailService mailService,
            UserService userService<% if (searchEngine === 'elasticsearch' || searchEngine === 'solr') { %>, UserSearchRepository userSearchRepository<% } %>) {
