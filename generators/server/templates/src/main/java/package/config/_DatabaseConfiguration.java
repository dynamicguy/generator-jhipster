...
import org.springframework.core.convert.converter.Converter;<% } %><% if (searchEngine === 'elasticsearch' || searchEngine === 'solr') { %>
...
@EnableTransactionManagement<% } %><% if (searchEngine === 'elasticsearch' || searchEngine === 'solr') { %>
